...
class Policy(object):
    ...
    def construct_ff_NN(self, state_placeholder, action_placeholder, task_errors, task_dyn, NUM_INPUTS = 1, NUM_OUTPUTS = 1, HIDDEN_UNITS_L1 = 10, HIDDEN_UNITS_L2 = 1):
        with self.g.as_default():
            ...
            self.b2 = tf.Variable(tf.zeros([HIDDEN_UNITS_L2]))
