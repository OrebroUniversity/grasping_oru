...
class Policy(object):
    ...
    def set_bookkeeping_files(self, relative_path):
        ...
        self.states_file_name = relative_path+'states.txt'
    ...
    def store_states(self):
        self.save_matrix_data_to_file(self.states_file_name, self.states)
    ...
    def policy_search(self, req):
        with self.g.as_default():
            ...
            if self.eval_episode:
                ...
                self.sigma = self.get_mean_action_mean()
