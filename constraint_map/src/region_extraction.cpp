...
void DistanceGrid::computeDistanceGrid2(SimpleOccMap *map) {
...
CellIdxCube DfunMaxEmptyCubeExtractor::getMaxCube2(SimpleOccMap *map) {
    ...
    distance_grid.computeDistanceGrid2(map);
    CellIdxCube cube;
    CellIndex id;
